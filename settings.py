...
MEDIA_URL = 'http://documents.latimes.com/media/'
...
YAML_PATH = os.path.join(ROOT_PATH, 'yaml')
DOCUMENT_DIR = os.path.join(YAML_PATH, 'documents')
PROJECT_DIR = os.path.join(YAML_PATH, 'projects')
